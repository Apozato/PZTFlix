...
function inicializarDados(){
    let dados = JSON.parse(localStorage.getItem("PZTflix-users"));
    if(dados === null){
        dados = [
            {
                nome: "ana",
            ...
            {
                nome: "fernanda",
                avatar: "img/users/avatar3.png",
                crianca: false
            },
            {
                nome: "gabriel",
                avatar: "img/users/image.png",
                crianca: true
            }
        ];
        localStorage.setItem("PZTflix-users", JSON.stringify(dados));
    }
    perfis = dados;
}
...
function adicionarPerfil(){
    ...
    perfis.push(perfil);
    localStorage.setItem('PZTflix-users', JSON.stringify(perfis));
